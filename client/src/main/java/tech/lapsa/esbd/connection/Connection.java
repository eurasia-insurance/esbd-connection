...
public interface Connection extends AutoCloseable {
    ...
    /**
     * Получение списка договоров Страхования туристов по дате заключения
     * 
     * @param aContractDate
     * @return returns tech.lapsa.esbd.jaxws.wsimport.ArrayOfCONTRACTOSTOURIST
     */
    ...
    /**
     * Возвращает XML с идентификатором договора и с идентификатором вида
     * страхования
     * 
     * @param aContractGlobalID
     * @return returns java.lang.String
     */
    ...
    /**
     * Проверка черновика полиса ОС ГПО ВТС без сохранения
     * 
     * @param aPolicy
    ...
    /**
     * Получение списка документов по идентификатору клиента
     * 
     * @param aClientID
     * @return returns tech.lapsa.esbd.jaxws.wsimport.ArrayOfCLIENTDOCUMENTS
     */

    public ArrayOfCLIENTDOCUMENTS getClientDocumentsListByID(int aClientID);

    /**
     * Получение списка групп клиента
     * 
     * @param aClientID
     * @return returns tech.lapsa.esbd.jaxws.wsimport.ArrayOfCLIENTGROUPS
     */
     ...
     * 
     * @param aClientDocuments
     * @return returns tech.lapsa.esbd.jaxws.wsimport.CLIENTDOCUMENTS
     */

    public CLIENTDOCUMENTS setClientDocuments(CLIENTDOCUMENTS aClientDocuments);

    /**
     * Добавить группы клиента
     * 
     * @param aClientGroups
     * @return returns tech.lapsa.esbd.jaxws.wsimport.CLIENTGROUPS
     */
     ...
     * @param aTFNUMBER
     * @param aTFREGCERTIF
     * @return returns tech.lapsa.esbd.jaxws.wsimport.ArrayOfVehicle
     */
    ...
    /**
     * Расчет страховой премии ОС ГПО ВТС с учетом скидки
     * 
     * @param aPolicy
     * @return returns int
     */
    ...
    /**
     * Сохранение договора Страхования туристов
     * 
     * @param aCONTRACTOSTOURIST
     * @return returns tech.lapsa.esbd.jaxws.wsimport.CONTRACTOSTOURIST
     */
    ...
    /**
     * Получение по идентификатору договора Страхования туристов
     * 
     * @param aCONTRACTID
     * @return returns tech.lapsa.esbd.jaxws.wsimport.CONTRACTOSTOURIST
     */
    ...
    /**
     * Получение списка договоров Страхования туристов по дате ввода (изменения)
     * 
     * @param aDateBeg
     * @param aDateEnd
     * @return returns tech.lapsa.esbd.jaxws.wsimport.ArrayOfCONTRACTOSTOURIST
    ...
    /**
     * Получение списка договоров Страхования туристов по номеру договора
     * 
     * @param aContractNumber
     * @return returns tech.lapsa.esbd.jaxws.wsimport.ArrayOfCONTRACTOSTOURIST
     */
